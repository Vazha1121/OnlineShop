...
export class NavComponent implements OnInit {
  ...
  public blueLi1!: boolean;
  public blueLi2!: boolean;
  public blueLi3!: boolean;
  public blueLi4!: boolean;
  public blueLi5!: boolean;
  ...
  getAuth() {
    ...
    this.apiServ.auth(headers).subscribe({
      next: (data: any) => {
  ...
  searchItem() {
    ...
    this.apiServ.searchWithKeyword(this.searchedText).subscribe({
      next: (data: any) => {
        ...
        if (
          this.searchedText == 'laptop' ||
          this.searchedText == 'laptops' ||
          this.searchedText == 'asus' ||
          this.searchedText == 'samsung' ||
          this.searchedText == 'apple' ||
          this.searchedText == 'lenovo' ||
          this.searchedText == 'hp' ||
          this.searchedText == 'acer' ||
          this.searchedText == 'dell' ||
          this.searchedText == 'msi' ||
          this.searchedText == 'lg'
        ) {
          ...
          this.searchedText == 'samsung' ||
          this.searchedText == 'xiaomi' ||
          this.searchedText == 'apple' ||
          this.searchedText == 'honor' ||
          this.searchedText == 'oneplus'
        ) {
